...
import VeBarStyle from "./sass/VerticalNav.module.scss";
import { useTranslation } from "react-i18next";
const VerticalNav = () => {
  const {t} = useTranslation();
  return (
    <div className={`${VeBarStyle["vertical-bar"]}`}>
      <NavLink className={`${VeBarStyle["action-btn"]}`}>
        <svg
          viewBox="0 0 24 24"
          preserveAspectRatio="xMidYMid meet"
          focusable="false"
          className={`${VeBarStyle["icon"]}`}
          style={{
            pointerEvents: "none",
            display: "block",
          }}
        >
          <g className={`${VeBarStyle["icon"]}`}>
            <path
              fill="white"
        ...
        <span className={`${VeBarStyle["btn-title"]}`}>{t('home')}</span>
      </NavLink>
      ...
      <NavLink className={`${VeBarStyle["action-btn"]}`}>
        ...
        <span className={`${VeBarStyle["btn-title"]}`}>Shorts</span>
      </NavLink>
      ...
      <NavLink className={`${VeBarStyle["action-btn"]}`}>
        ...
        <span className={`${VeBarStyle["btn-title"]}`}>{t('subscriptions')}</span>
      </NavLink>
      ...
      <NavLink className={`${VeBarStyle["action-btn"]}`}>
        ...
        <span className={`${VeBarStyle["btn-title"]}`}>{t('library')}</span>
      </NavLink>
      ...
      <NavLink className={`${VeBarStyle["action-btn"]}`}>
        ...
        <span className={`${VeBarStyle["btn-title"]}`}>{t('history')}</span>
      </NavLink>
    </div>
  );
};
