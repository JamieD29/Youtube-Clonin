...
import nonStickStyle from "./scss/Genres/NonStick.module.scss";
...
const NonStickGenres = () => {
  ...
  return (
    <div className={`${nonStickStyle["non-stick"]}`}>
      <Swiper
        spaceBetween={0}
        slidesPerView={12}
      ...
      <SwiperSlide><BtnGenres name="Sports"/></SwiperSlide>   */}
        ...
        {genresList.genres.map((gener, index) => {
          return (
            <SwiperSlide key={gener + index} className={`${nonStickStyle["genre"]}`}>
              {" "}
